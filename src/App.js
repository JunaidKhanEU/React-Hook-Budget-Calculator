...
// ]
const initialExpenses = window.localStorage.getItem('expenses') ? JSON.parse(window.localStorage.getItem('expenses')) : []
  ...
  const handleSubmit = (e) => {
    ...
    if (charge !== '' && amount > 0) {
      if (edit) {
        ...
        const newExpenses = [...expenses, { id: uuid(), charge: charge, amount: amount }]
      ...
      // alert
      handleAlert({ type: 'danger', text: 'charge and amount cannot be empty value' })
    }
  }
